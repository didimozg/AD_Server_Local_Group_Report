...
3. include reproduction steps if safe to share
...
- unreachable servers
- blocked DCOM or WinRM connectivity
- stale or inaccurate source inventories

Please distinguish operational environment issues from code-level security issues when reporting.
