...
function Test-IsAuthenticationCimError {
    ...
    return (
        ...
        $factSet.SearchText -match '\\x{041E}\\x{0442}\\x{043A}\\x{0430}\\x{0437}\\x{0430}\\x{043D}\\x{043E} \\x{0432} \\x{0434}\\x{043E}\\x{0441}\\x{0442}\\x{0443}\\x{043F}\\x{0435}' -or
        $factSet.SearchText -match 'The user name or password is incorrect' -or
        $factSet.SearchText -match '\\x{041D}\\x{0435}\\x{0432}\\x{0435}\\x{0440}\\x{043D}\\x{043E}\\x{0435} \\x{0438}\\x{043C}\\x{044F} \\x{043F}\\x{043E}\\x{043B}\\x{044C}\\x{0437}\\x{043E}\\x{0432}\\x{0430}\\x{0442}\\x{0435}\\x{043B}\\x{044F} \\x{0438}\\x{043B}\\x{0438} \\x{043F}\\x{0430}\\x{0440}\\x{043E}\\x{043B}\\x{044C}' -or
        $factSet.SearchText -match 'Logon failure' -or
        $factSet.SearchText -match 'account restrictions' -or
        $factSet.SearchText -match '\\x{043E}\\x{0433}\\x{0440}\\x{0430}\\x{043D}\\x{0438}\\x{0447}\\x{0435}\\x{043D}\\x{0438}\\x{0439} \\x{0443}\\x{0447}\\x{0435}\\x{0442}\\x{043D}\\x{043E}\\x{0439} \\x{0437}\\x{0430}\\x{043F}\\x{0438}\\x{0441}\\x{0438}' -or
